# PS1_72_InsertAbsences20260715.ps1
# Inserts planned absences into SickLeaves for 2026-07-15.
#
# Source: Daily Absence Overview 2026-07-15
#   SL:       6  (Sharon Huber, Sebastian Höck, Pascal Dutz, Kaan Arslan, Kevin Heynen, Mark Bachmann)
#   AL:       13 (Duc Quy Huynh, Timon Philippen, Victoria Scholz, Erne Kis, Christian Koch, Abdulrahman Aldera,
#                 Bishal Maharjan, Francois Sicot, Kamil Filipowicz, Kavinraj Pathmanathan, Marcus Rusch,
#                 Merlin Voss, Viktor Winter)
#   OFF/OL/CD: 6 (Tri Toan Nguyen, Aleksandrina Dencheva, Zehra Sila Görgün, Arevig Ketenjian,
#                 Hamza Forrousso, Krishnendu Das)
#   UL:        0
#   Night:     1  (Anas Daba -- working night shift, NOT inserted as absence)
#
...
$entries = @(
    ...
    [PSCustomObject]@{ Name="Kaan Arslan";                LeaveType="SL";  FirstDay=$TODAY; LastDay=$TODAY },
    [PSCustomObject]@{ Name="Kevin Heynen";               LeaveType="SL";  FirstDay=$TODAY; LastDay=$TODAY },
    ...
    [PSCustomObject]@{ Name="Bishal Maharjan";            LeaveType="AL";  FirstDay=$TODAY; LastDay=$TODAY },
    ...
    [PSCustomObject]@{ Name="Tri Toan Nguyen";            LeaveType="OFF"; FirstDay=$TODAY; LastDay=$TODAY },
    [PSCustomObject]@{ Name="Aleksandrina Dencheva";      LeaveType="OFF"; FirstDay=$TODAY; LastDay=$TODAY },
    ...
    [PSCustomObject]@{ Name="Hamza Forrousso";            LeaveType="OFF"; FirstDay=$TODAY; LastDay=$TODAY },
...
Write-Host ""
Write-Host "=== PS1_72: Insert Absences $TODAY ===" -ForegroundColor Yellow
Write-Host "    Expected: 6 SL + 13 AL + 6 OFF = 25 entries" -ForegroundColor Yellow
Write-Host ""
...
Write-Host ""
Write-Host "--- Step 2: Duplicate check (already in SickLeaves for $TODAY) ---" -ForegroundColor Cyan
...
Write-Host ""
Write-Host "--- Step 3: INSERT into SickLeaves ---" -ForegroundColor Cyan
...
$verifySql = "SELECT COUNT(*) FROM SickLeaves WHERE FirstDay <= '$TODAY' AND LastDay >= '$TODAY'"
...
Write-Host "  SL  = 6  (Sharon Huber, Sebastian Höck, Pascal Dutz, Kaan Arslan, Kevin Heynen, Mark Bachmann)"
Write-Host "  AL  = 13 (Duc Quy Huynh, Timon Philippen, Victoria Scholz, Erne Kis, Christian Koch, Abdulrahman Aldera,"
Write-Host "            Bishal Maharjan, Francois Sicot, Kamil Filipowicz, Kavinraj Pathmanathan, Marcus Rusch,"
Write-Host "            Merlin Voss, Viktor Winter)"
Write-Host "  OFF = 6  (Tri Toan Nguyen, Aleksandrina Dencheva, Zehra Sila Görgün, Arevig Ketenjian,"
Write-Host "            Hamza Forrousso, Krishnendu Das)"
Write-Host "  Night shift (NOT inserted): Anas Daba"
Write-Host ""
...
Write-Host ""
Write-Host "=== PS1_72 complete ===" -ForegroundColor Green
